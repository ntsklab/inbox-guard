...
| `MAX_CONTENT_RATIO` | No | `0.9` | Max mention-to-content ratio (requires 2+ mentions; `1.0` disables the check) |
| `MAX_BODY_BYTES` | No | `1048576` | Max request body size in bytes; larger requests are rejected with `413` |
